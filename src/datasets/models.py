import re
import itertools
from src.core.io.plugins.database.postgresql import *
...
class AITableObject(TableObject):
    """
    config
    ------
        <table-name>:
...
class AIDataFrameObject(TableObject):
    """
    config
    ------
        <dataframe-name>:
...
class AIFunctionObject(FunctionObject):
    pass
